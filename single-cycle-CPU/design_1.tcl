...
xilinx.com:user:single_cycle_cpu:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: single_cycle_cpu_0, and set properties
  set single_cycle_cpu_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:single_cycle_cpu:1.0 single_cycle_cpu_0 ]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins single_cycle_cpu_0/rst_n]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins single_cycle_cpu_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net single_cycle_cpu_0_bus_a [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins single_cycle_cpu_0/bus_a]
  connect_bd_net -net single_cycle_cpu_0_bus_a_o [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins single_cycle_cpu_0/bus_a_o]
  connect_bd_net -net single_cycle_cpu_0_bus_b [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins single_cycle_cpu_0/bus_b]
  connect_bd_net -net single_cycle_cpu_0_bus_b_o [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins single_cycle_cpu_0/bus_b_o]
  connect_bd_net -net single_cycle_cpu_0_bus_wo [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins single_cycle_cpu_0/bus_wo]
  connect_bd_net -net single_cycle_cpu_0_cur_pc [get_bd_pins axi_gpio_3/gpio2_io_i] [get_bd_pins single_cycle_cpu_0/cur_pc]
  connect_bd_net -net single_cycle_cpu_0_imm [get_bd_pins axi_gpio_3/gpio_io_i] [get_bd_pins single_cycle_cpu_0/imm]
  connect_bd_net -net single_cycle_cpu_0_inst [get_bd_pins axi_gpio_5/gpio_io_i] [get_bd_pins single_cycle_cpu_0/inst]
  connect_bd_net -net single_cycle_cpu_0_next_pc [get_bd_pins axi_gpio_4/gpio2_io_i] [get_bd_pins single_cycle_cpu_0/next_pc]
