...
HD_PWD='D:/Vivado/Xilinx/single-cycle-CPU/single-cycle-CPU.runs/design_1_single_cycle_cpu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_single_cycle_cpu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_single_cycle_cpu_0_0.tcl
